            ...
            <table className="border-collapse border border-slate-500 ... select-none">
              <thead>
                <tr className='bg-red-400 text-2xl'>
                  <th className="border border-slate-600 ... px-10 py-5 ">Brand Name</th>
                  <th className="border border-slate-600 ...  px-10 py-5">Model Name</th>
                  <th className="border border-slate-600 ...  px-10 py-5">Color</th>
                  <th className="border border-slate-600 ...  px-10 py-5">Year</th>
                  <th className="border border-slate-600 ...  px-10 py-5">Delete</th>
                </tr>
              </thead>
              <tbody>
                {
                  data.map((item) => (
                    <tr key={item._id} >
                      <td className="border border-slate-600 ...  px-10 py-5 text-xl">{item.brandName}</td>
                      ...
                      <td className='border border-slate-600 ... text-xl'><Button variant="warning" onClick={() => handleDelete(item._id)}>Delete</Button></td>
                    </tr>
                  ))
                }
              </tbody>
